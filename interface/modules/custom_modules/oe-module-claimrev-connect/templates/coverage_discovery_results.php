        ...
        foreach ($coverageResults as $coverage) {
            ...
            <div class="<?php echo $cdIndex > 1 ? 'border-top pt-3 mt-3' : ''; ?>">
                ...
                <?php if (!empty($coverage->policyDate)) { ?>
                    <?php $startDate = is_string($coverage->policyDate->startDate ?? null) ? $coverage->policyDate->startDate : ''; ?>
                    <?php if ($startDate !== '') { ?>
                        <div class="row mb-1">
                    ...
                    <?php if (!empty($coverage->policyDate->endDate)) { ?>
                        <div class="row mb-1">
                            ...
                            <div class="col"><?php echo text(substr((string) $coverage->policyDate->endDate, 0, 10)); ?></div>
                        </div>
                    <?php } ?>
                <?php } ?>
